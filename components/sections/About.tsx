    ...
    <section id="about" aria-labelledby="about-heading"  className="scroll-mt-16 py-2">
      <Container>
        <SectionHeading
          ...
          description="A short summary of how I work and what I bring to a team"
        />
          ...
          {PILLARS.map((pillar, index) => (
            <Reveal key={pillar.title} delay={index * 80}>
              <div className="h-full rounded-xl border border-border bg-surface p-6">
                ...
                <p className="mt-2 text-sm leading-relaxed text-muted text-justify">{pillar.description}</p>
              </div>
            </Reveal>
          ))}
        </div>
